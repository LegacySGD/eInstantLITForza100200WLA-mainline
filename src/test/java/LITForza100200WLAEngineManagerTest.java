...
public class LITForza100200WLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITForza100200WLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITForza100200WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITForza100200WLAIW/InitOutcome.xml").getDocumentElement();
